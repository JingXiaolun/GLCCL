...
####################################################### MSRVTT-7K DataSet #######################################################################
## ViT-B/32
#JOB_NAME='tc_clip_msrvtt_7k_vit32'
...
## ViT-B/16
#JOB_NAME='tc_clip_msrvtt_7k_vit16'
#ABLATION_TYPE='Var_Loss'
#ABLATION_NAME='Weight_0.1'
#FILE_DATA_PATH='../../../DataSet/MSRVTT/data/file/'
#VIDEO_DATA_PATH='../../../DataSet/MSRVTT/data/compressed'
